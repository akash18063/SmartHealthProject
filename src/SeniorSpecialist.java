...
public class SeniorSpecialist extends Doctor {
    ...
    SeniorSpecialist()
    {
        this.setPositionInDepartment(4);
    ...
    int transferToDepartment(Connection connection, BufferedReader bufferedReader) throws SQLException, IOException {
        ...
        PreparedStatement preparedStatement=connection.prepareStatement("insert into TransferRequest(doctor_from_id,dept_from_id,dept_to_id,patient_id) values(?,?,?,?)");
